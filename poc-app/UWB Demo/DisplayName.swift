...
enum DisplayName {
    ...
    static func resolved() -> String {
        ...
        // The simulator runs `DemoTeam`, whose scripted team is BRAVO, CHARLIE
        // and DELTA. Seeding ALPHA puts us at the head of that roster instead
        // of showing whichever Mac-derived device name the simulator carries.
        let seeded = "ALPHA"
        #else
